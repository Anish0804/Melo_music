...
function FooterMusicPlayer({ music }) {
  ...
  useEffect(() => {
    async function fetchIPFSMusic() {
      if (musicName.startsWith("ipfs://")) {
        const ipfsHash = musicName.substring(7);
        ...
        audioElement.current.src = require("../assets/music/" + musicName);
      }
    }
  ...
  return (
    <div style={useStyle.component} className={"footer-player"}>
      ...
      <Button
        startIcon={
          <Avatar variant="square" src={require("../assets/img/" + img)} alt={name} />
        }
        onClick={handleBannerToggle}
        className="curr-music-container"
      >
      ...
      <div className="playback-controls">
        ...
        <audio ref={audioElement} src="" preload={"metadata"} />
